...
def index():
    ...
    for res in results:
        single_date = {}
        single_date['entry_date'] = res['entry_date']
        single_date['protein'] = res['protein']
        single_date['carbohydrates'] = res['carbohydrates']
        single_date['fat'] = res['fat']
        single_date['calories'] = res['calories']
...
def view(date):
    ...
    date_cur = db.execute('select id, entry_date from log_date where entry_date = ?', [date])
